    ...
    <div>
        <main class="flex flex-col justify-center h-full py-16 px-4 md:px-6 lg:px-8 xl:px-10">
            <Card :class="['flex justify-center items-center py-6 w-full max-w-md mx-auto']">
                <template #content>
                    <form class="w-full px-8" @submit.prevent="customersStore.updateCustomer(props.id)">
                        <div class="border-b border-gray-100 mb-4 p-3">
                            <h2 class="text-gray-900 font-semibold text-lg text-center">Edit Customer</h2>
                        </div>
                        
                        <div class="mb-6 relative">
                            <input type="text" id="name" placeholder="Name" v-model="customer.name" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none">
                        ...
                        <div class="mb-6 relative">
                            <select v-model="customer.type" id="type" class="mt-2 w-full bg-white border-b-2 border-gray-300 p-2.5 text-sm text-gray-700 shadow-sm transition ease-in-out focus:border-blue-600 focus:ring-blue-600 focus:outline-none">
                                <option v-for="types in customerTypes" :key="types.id" :value="types.id" :selected="(customer.type == types.id)">{{ types.text }}</option>
                            </select>
                        ...
                        <div class="mb-6 relative">
                            <input type="email" id="email" placeholder="Email" v-model="customer.email" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none">
                        ...
                        <div class="mb-6 relative">
                            <textarea type="text" id="address" placeholder="Address" v-model="customer.address" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none"></textarea>
                        ...
                        <div class="mb-6 relative">
                            <input type="text" id="city" placeholder="City" v-model="customer.city" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none">
                        ...
                        <div class="mb-6 relative">
                            <input type="text" id="state" placeholder="State" v-model="customer.state" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none">
                        ...
                        <div class="mb-6 relative">
                            <input type="text" id="postalCode" placeholder="Postal Code" v-model="customer.postalCode" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none">
